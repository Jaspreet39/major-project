        ...
        <>
            <form className="form-group">
                ...
                <div class="container col-lg-6">
                    ...
                    <input className='fname' type="text" placeholder="Enter Full Name" name="fname" />
                    <br></br>
                    <br></br>
                    ...
                    <input className='ps' type="password" placeholder="Enter Password" name="ps" />
                    <br></br>
                    <br></br>
                    ...
                    <br></br>
                    <br></br>
                    <label for="cn"><b>Contat No.</b></label>
